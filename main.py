...
def main(args):
    ...
    plt.plot(blocked_percents, label='blocked')
    plt.plot(dropped_percents, label="dropped")
    plt.xlable('Number of Events')
    plt.ylabel('Percentages')
    plt.legend()
    plt.title('Percentages of Dropped and Blocked Calls')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps', default=600000, type=int, help='Steps taken in a single simulation run')
